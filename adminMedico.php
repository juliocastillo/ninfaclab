...
class Model_form {
    ...
    function make_table($consulta){
        ...
        $tblbody .= "<tr>".
            "<td><a href='adminMedico.php?req=3&id=".$row['id']."'>".$row['nombre']."</td>".  
            "<td>".$row['jvp']."</td>".  
            "<td>".$row['direccion']."</td>".  
            "</tr>";
        }
...
if (!$req) {//ingresar nuevo registro desde cero
    ...
    $args = array ( // parametro que se pasaran a la vista
            'form'      => 'adminMedico.html',
            'FileName'  => 'adminMedico.php?req=2',
            'FormTitle' => 'Creación/Edición de Medicos',
            'id'        => '',
            'nombre'    => '',
            'jvp'       => '',
            'direccion' => '',
...
elseif ($req == 2) {//ingresar un nuevo registro
    ...
    print "<script>window.location = 'adminMedico.php'</script>";    
}
elseif ($req == 3) {//mostrar para modificar registro
    ...
    $args = array ( // parametro que se pasaran a la vista
            'form'      => 'adminMedico.html',
            'FileName'  => 'adminMedico.php?req=4',
            'FormTitle' => 'Creación/Edición Medico',
            'id'        => $rec['id'],
            'nombre'    => $rec['nombre'],
            'jvp'       => $rec['jvp'],
