...
class Model_form {
    ...
    function make_table($consulta){
        ...
        $tblbody .= "<tr>".
            "<td><a href='adminArealab.php?req=3&id=".$row['id']."'>".$row['nombre']."</td>".  
            "</tr>";
        }
        return $tblbody;
    }
...
if (!$req) {//ingresar nuevo registro desde cero
    ...
    $args = array ( // parametro que se pasaran a la vista
            'form' => 'adminArealab.html',
            'FileName' => 'adminArealab.php?req=2',
            'FormTitle' => 'Creación/Edición Areas laboratorio',
            'id'=> '',
            'nombre' => '',
            'tblbody' => $tblbody
            );
...
elseif ($req == 2) {//ingresar un nuevo registro
    ...
    print "<script>window.location = 'adminArealab.php'</script>";    
}
elseif ($req == 3) {//mostrar para modificar registro
    ...
    $args = array ( // parametro que se pasaran a la vista
            'form' => 'adminArealab.html',
            'FileName' => 'adminArealab.php?req=4',
